/**
 * Script to extract glyph width metrics from OSS fonts (.ttf).
 *
 * How to use:
 * 1. Place the.ttf of the target font in scripts/fonts/
 *   2. npx tsx scripts/extract-font-metrics.ts
 * 3. Paste the output TypeScript code into packages/renderer/src/data/font-metrics.ts
 */
