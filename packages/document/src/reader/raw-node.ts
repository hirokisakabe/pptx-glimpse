 ...
 *
 * Elements that PptxSourceModel does not represent typed (unsupported fill / effect / extension etc.)
 * Save as `RawOoxmlNode` / `RawSidecar` and establish structural round-trip.
 * The plain object generated by fast-xml-parser is converted into a raw tree while keeping the qualified name.
 * .
 */
