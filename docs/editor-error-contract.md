...
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `invalid-command`   | `packages/editor/src/command-contract.ts`: shared rejection classification; `packages/editor/src/commands/`: domain handlers; `packages/editor/src/index.ts`: batch validation and source-node convenience boundaries | Same-code `PptxEditorError` | Headless apply/applyAll rejection and atomicity, including exhaustive command routing/classification, group topology/selection plus cross-slide source/destination atomicity, ID/handle selection remap, and undo/redo restoration; high-level field/cause preservation |
