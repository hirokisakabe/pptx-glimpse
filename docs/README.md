...
| [`development/setup.md`](./development/setup.md)                                                                                                         | Repository contributors starting local development. Covers installation, common validation commands, and the local editor preview.                                                                                      |
...
| Public package READMEs: [`core`](../packages/core/README.md), [`document`](../packages/document/README.md), and [`editor`](../packages/editor/README.md) | npm users choosing or starting with a public package. These files document the supported public entry points and common usage.                                                                                          |
| Public package guides, currently [`packages/document/docs/`](../packages/document/docs/)                                                                 | npm users who need detailed package guides, feature support, or API-oriented workflows. Put a new guide under the owning public package and describe public root exports rather than repository internals.              |
| [`packages/renderer/README.md`](../packages/renderer/README.md)                                                                                          | Repository maintainers working on the private renderer package. It explains that internal package's local ownership and is not npm-user documentation.                                                                  |
