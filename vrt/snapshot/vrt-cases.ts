...
export const VRT_CASES = [
  ...
  { name: "general-affine-cross-parent-move", fixture: "general-affine-cross-parent-move.pptx" },
  { name: "cross-slide-drawing-move", fixture: "cross-slide-drawing-move.pptx" },
